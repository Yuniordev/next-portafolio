...
vmap <silent> ,em :call phpactor#ExtractMethod()
vmap <silent> ,ee :call phpactor#ExtractExpression(v:true)
nmap <silent> ,ee :call phpactor#ExtractExpression(v:false)
nmap ,cc :call phpactor#ClassNew()
nmap ,tt :call phpactor#Transform()
nmap ,K :call phpactor#Hover()
nmap ,ot :call phpactor#GotoDefinitionTab()
nmap ,ov :call phpactor#GotoDefinitionVsplit()
nmap ,oh :call phpactor#GotoDefinitionHsplit()
nmap ,oo :call phpactor#GotoDefinition()
nmap ,nn :call phpactor#Navigate()
nmap ,mm :call phpactor#ContextMenu()
nmap ,u :call phpactor#UseAdd()
nnoremap ,o :.Gbrowse
nnoremap <silent> ,  :noh
noremap ,c :bd
noremap ,w :bn
